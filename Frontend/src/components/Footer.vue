<template>
  <footer class="bg-[#212121] border-solid border-t border-gray-500">
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <!-- 
      <p
        class="font-[Avenir_Next_Roman] mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400"
      >
      ...
      <ul class="mt-12 flex justify-center gap-6 md:gap-8">
        <li>
          <a
            href="https://www.facebook.com/profile.php?id=61575250581884&mibextid=ZbWKwL"
            rel="noreferrer"
            target="_blank"
            class="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
          >
        ...
        <li>
          <a
            href="https://www.instagram.com/tagcon_buja?igsh=NmFwNXh4MXJ2cjF1"
            rel="noreferrer"
            target="_blank"
            class="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
          >
        ...
        <li>
          <a
            href="https://www.youtube.com/@TAGCONBUJA"
            rel="noreferrer"
            target="_blank"
            class="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
          >
            <span class="sr-only">YouTube</span>
            <svg class="size-6" fill="currentColor" viewBox="0 0 48 48" aria-hidden="true">
              <path
      ...
      <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400">
        ...
        <a
          target="_blank"
          style="color: #6a7282; text-decoration: underline"
          href="https://github.com/JuniorAfroCoder"
          >JuniorAfroCoder</a
        >
      </p>
    </div>
