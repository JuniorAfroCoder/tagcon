<template>
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    <div class="grid grid-cols-1 md:grid-cols-12 border">
      <div class="bg-stone-950 md:col-span-4 p-10 text-white">
        <p class="font-[Avenir_Next] mt-4 text-sm leading-7 font-regular uppercase">
          Have Questions?
        </p>
        <h3 class="font-[Muller] text-4xl sm:text-5xl leading-normal font-extrabold tracking-tight">
          Get In <span>Touch</span>
        </h3>
        <p class="font-[Monda] mt-4 leading-7 text-gray-200">
        ...
        <div class="flex items-center mt-5">
          ...
          <span class="font-[Monda] text-sm">54, Boulevard Mwezi Gisabo, Bujumbura, Burundi</span>
        </div>
        <div class="flex items-center mt-5">
          <svg
            class="h-6 mr-2 text-indigo-600"
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
          ...
          <span class="font-[Monda] text-sm">+257 62 89 15 47</span>
        </div>
        <div class="flex items-center mt-5">
          <svg
            class="h-6 mr-2 text-indigo-600"
          ...
          <span class="font-[Monda] text-sm">24/7</span>
        </div>
      </div>
