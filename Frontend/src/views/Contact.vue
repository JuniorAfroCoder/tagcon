    ...
    <div class="grid grid-cols-1 md:grid-cols-12">
      ...
      >
        ...
        <div class="flex items-center mt-5">
          ...
          <span class="font-[Avenir_Next_Roman] text-md"
            >No.22 E2, Rohero 1, Avenue de la Révolution, Église Méthodiste Unie Burundi</span
          >
        </div>
        <div class="flex items-center mt-5">
          <svg
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
          ...
          <span class="font-[Avenir_Next_Roman] text-md">+257 62 89 15 47</span>
        </div>
        <div class="flex items-center mt-5">
          <svg class="h-6 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256">
            <g
              fill="#d34202"
              fill-rule="nonzero"
              stroke="none"
