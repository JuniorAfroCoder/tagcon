...
<template>
  <header
    class="fixed w-full z-20 bg-black border-solid border-b border-gray-500 text-white dark:bg-gray-900"
  >
        ...
        <div class="hidden md:block max-w-dvh">
          <nav aria-label="Global">
            <ul class="flex items-center gap-10 text-sm">
              <li>
                <a class="text-white transition dark:text-white dark:hover:text-white/75" href="#">
                  About
                </a>
              </li>
